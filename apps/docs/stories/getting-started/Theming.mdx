...
Sando ships with **8 curated flavors** in two tiers. **Core** flavors are always bundled with `@sando-ds/tokens/css`. **Showcase** flavors require an opt-in import.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>⬜ **neutral**</td>
      <td>Blue + cool slate</td>
      <td>Professional, zero brand personality</td>
      <td>B2B, enterprise, internal tools</td>
    </tr>
    <tr>
      <td>🍱 **sando**</td>
      <td>Brown</td>
...
**Showcase** (opt-in: `import "@sando-ds/tokens/css/flavors/<name>"`):
...
All 8 built-in flavors meet these contrast standards in every mode:
...
- **[Flavors Reference](?path=/docs/flavors-overview--docs)** — Explore all 8 flavors in detail
