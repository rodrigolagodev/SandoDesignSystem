...
> **💡 7 Flavors, Infinite Possibilities**
>
> Sando ships with 7 curated flavors. Each one defines not just colors, but typography pairings, spacing rhythm, border radius personality, animation timing, and elevation style — a complete design language in a single `flavor` attribute.
