...
<Meta title="Guides/Flavor Philosophy" />
...
- **Flavors** (the filling): The brand identity (original, neutral, sando, tonkatsu, strawberry, egg-salad, kiwi, nori)
...
Sando ships with 8 curated flavors split into two tiers: **Core** (bundled by default) and **Showcase** (opt-in). Each is inspired by a real sando variety.
...
<table>
  ...
  <tbody>
    <tr>
      <td>`original`</td>
      <td>The classic katsu sando</td>
      <td>Warm orange tones—reliable and timeless</td>
    </tr>
    <tr>
      <td>`neutral`</td>
      <td>The professional baseline</td>
      <td>Cool slate grays + blue accent—zero brand personality, maximum readability</td>
    </tr>
    <tr>
      <td>`sando`</td>
      <td>The house special</td>
      <td>A refined take with distinctive personality</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>`tonkatsu`</td>
      <td>Deep-fried katsu</td>
      <td>Rich, golden warmth—bold and appetizing</td>
    </tr>
    <tr>
      <td>`strawberry`</td>
      <td>Fruit sando (ichigo sando)</td>
      <td>Pink and red accents—fresh and vibrant</td>
    </tr>
    <tr>
      <td>`egg-salad`</td>
      <td>Tamago sando</td>
      <td>Soft yellows—friendly and approachable</td>
    </tr>
    <tr>
      <td>`kiwi`</td>
      <td>Fruit sando (kiwi)</td>
      <td>Greens—natural and energizing</td>
    </tr>
    <tr>
      <td>`nori`</td>
      <td>Japanese Brutalism</td>
      <td>Stark black + vermillion—impactful and modern</td>
    </tr>
  </tbody>
</table>

```html
<!-- Core flavors (always available with @sando-ds/tokens/css) -->
<sando-button flavor="original">Original</sando-button>
<sando-button flavor="neutral">Neutral</sando-button>
<sando-button flavor="sando">Sando</sando-button>

<!-- Showcase flavors (require opt-in import) -->
...
<sando-button flavor="nori">Nori</sando-button>
```
...
<table>
  <thead>
    <tr>
      <th>Feature</th>
      <th>Traditional `data-theme`</th>
      <th>React `ThemeProvider`</th>
      <th>**Sando `flavor`**</th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td>Requires nested provider</td>
    ...
    <tr>
      ...
      <td>**Flavor analogy**</td>
    </tr>
    <tr>
      <td>**DOM Overhead**</td>
      <td>Extra wrappers</td>
      <td>Extra providers</td>
      <td>**None**</td>
    </tr>
    <tr>
      <td>**Dark Mode**</td>
      <td>Manual toggle</td>
      <td>Manual toggle</td>
      <td>**Automatic via media queries**</td>
    </tr>
  </tbody>
</table>
...
- **[Flavors Reference](?path=/docs/flavors-overview--docs)** — Deep dive into flavor tokens and how they're built
- **[Theming Guide](?path=/docs/getting-started-theming--docs)** — Practical tutorial for applying flavors to your project
