...
SandoDesignSystem/
├── packages/
│   ├── tokens/          # @sando-ds/tokens — Design tokens (Ingredients, Flavors, Recipes)
│   └── components/      # @sando-ds/components — Web Components (Lit 3+)
├── apps/
│   └── docs/            # @sando-ds/docs — Storybook (components, docs, playground)
